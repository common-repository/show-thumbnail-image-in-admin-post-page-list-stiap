 ...
 * * Plugin Name
 *
 * @package    Show Thumbnail Image In Admin Post / Page List (STIAP)
 ...
 * @Wordpress-plugin
 * 
 * Plugin Name: Show Thumbnail Image In Admin Post / Page List (STIAP)
